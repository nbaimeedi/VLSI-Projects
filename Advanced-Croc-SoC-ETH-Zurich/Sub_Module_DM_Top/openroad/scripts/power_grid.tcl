...
#add_pdn_stripe -grid {core_grid} -layer {Metal2} -width {4} -offset {10} \
               -spacing 10 -pitch 28 -followpins -nets {VDD}

#get_nets
#add_pdn_stripe -grid {core_grid} -layer {Metal2} -width {4} -offset {24} \
