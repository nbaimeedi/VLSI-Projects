...
# read liberty files of sub-modules cve2_core (CPU Core), timer_unit (Timer Unit), and dm_top (Debug Module)
#yosys read_liberty -lib "../openroad/out/dm_top.lib"
#yosys read_liberty -lib "../openroad/out/timer_unit.lib"
#yosys read_liberty -lib "../openroad/out/cve2_core.lib"
